...
int main(int argc, char** argv)
{
  ...
  n.param("mesh_resource", mesh_resource, std::string("file:///home/thanos/Documents/ICRA_2026/src/PredRecon/Planner/Code/src/uav_simulator/Utils/odom_visualization/meshes/f250.dae"));
